// be careful to not mutate state, use Object.assign and the spread operator
// design state and connect components first
// single reducer

import {RESTART_GAME, MAKE_GUESS, AURAL_FEEDBACK} from './actions';
